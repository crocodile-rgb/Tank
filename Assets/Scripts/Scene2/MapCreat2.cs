...
public class MapCreat2 : MonoBehaviour
{
    ...
    private void InitMap()
    {
        ...
        //玩家2
        GameObject player2 = Instantiate(items[3], new Vector3(2, -8, 0), Quaternion.identity);
        player2.GetComponent<Born>().BorningPlayer2 = true;
        //敌人
